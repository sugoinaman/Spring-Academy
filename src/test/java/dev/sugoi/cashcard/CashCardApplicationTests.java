...
class CashCardApplicationTests {
    ...
    void shouldNotUpdateACashCardThatDoesNotExist() {
        ...
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123").exchange("/cashcards/9999", HttpMethod.PUT, request, Void.class);
    ...
    // we can't check the status code this way
    @Test
    @DirtiesContext
    void shouldDeleteAnExistingCashCardUsingDelete() {
    ...
    @Test
    @DirtiesContext
    void shouldDeleteAnExistingCashCardUsingExchange() {
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
    ...
    void shouldNotDeleteACashCardThatDoesNotExist(){
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1","abc123")
                .exchange("/cashcards/12932",HttpMethod.DELETE,null, Void.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
}